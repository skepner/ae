...
void ae::py::chart_v3(pybind11::module_& mdl)
{
    ...
    pybind11::class_<Chart, std::shared_ptr<Chart>>(chart_v3_submodule, "Chart")                                       //
        ...
        // .def("name", [](const Chart& chart, std::optional<size_t> projection_no) { return chart.name(projection_no.has_value() ? projection_index{*projection_no} : std::nullopt); },
        ...
        .def("__str__",
             [](const Chart& chart) { return chart.name(); }) //
        ;
    ...
    //                             use_dimension_annealing_from_bool(dimension_annealing), optimization_options{optimization_precision{rough ? optimization_precision::rough :
    //                             optimization_precision::fine}}, disconnect);
    ...
    //                                         ae::chart::v2::remove_source_projection{remove_source_projection ? ae::chart::v2::remove_source_projection::yes :
    //                                         ae::chart::v2::remove_source_projection::no}, ae::chart::v2::unmovable_non_nan_points{unmovable_non_nan_points ?
    //                                         ae::chart::v2::unmovable_non_nan_points::yes : ae::chart::v2::unmovable_non_nan_points::no});
    //                 chart.projections_modify().sort();
    //             }, //
