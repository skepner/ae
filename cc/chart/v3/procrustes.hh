...
namespace ae::chart::v3
{
    ...
    {
        procrustes_summary_t(antigen_index number_of_antigens, serum_index number_of_sera)
            : antigen_distances(*number_of_antigens), serum_distances(*number_of_sera), antigens_by_distance(*number_of_antigens)
        {
        }
        ...
        antigen_indexes antigens_by_distance;         // indices antigens sorted by distance (longest first)
    ...
    {
        antigen_index number_of_antigens;
        serum_index number_of_sera;
        antigen_index antigen_being_tested;
        // std::optional<antigen_index> vaccine_antigen;
    };
    ...
    procrustes_summary_t procrustes_summary(const Layout& primary, const Layout& transformed_secondary, const procrustes_summary_parameters& parameters);
