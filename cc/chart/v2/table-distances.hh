...
// ----------------------------------------------------------------------
    ...
    class TableDistances : public detail::DistancesBase
    {
     public:
        ...
        void update(const Titer& titer, size_t p1, size_t p2, double column_basis, double adjust, multiply_antigen_titer_until_column_adjust mult)
        {
            try {
...
namespace std
{
    template <> struct iterator_traits<ae::chart::v2::detail::DistancesBase::IteratorForPoint>
    {
