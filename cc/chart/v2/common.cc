...
class CommonAntigensSera::Impl
{
 public:
    ...
    {
     public:
        ChartData(const ae::chart::v2::Chart& primary, const ae::chart::v2::Chart& secondary, match_level_t match_level);
        template <typename Selector> ChartData(const ae::chart::v2::Chart& primary, const ae::chart::v2::Chart& secondary, Selector selector, match_level_t match_level);
        ChartData(const ae::chart::v2::Chart& primary);
...
template <> CommonAntigensSera::Impl::ChartData<common::AntigenEntry>::ChartData(const ae::chart::v2::Chart& primary, const ae::chart::v2::Chart& secondary, match_level_t match_level)
...
template <> template <> CommonAntigensSera::Impl::ChartData<common::AntigenEntry>::ChartData(const ae::chart::v2::Chart& primary, const ae::chart::v2::Chart& secondary, common::antigen_selector_t selector, match_level_t match_level)
    : primary_(primary.number_of_antigens()), secondary_(secondary.number_of_antigens()),
      primary_base_{0}, secondary_base_{0},
      min_number_{std::min(primary_.size(), secondary_.size())}
{
...
template <> CommonAntigensSera::Impl::ChartData<common::AntigenEntry>::ChartData(const ae::chart::v2::Chart& primary)
...
template <> CommonAntigensSera::Impl::ChartData<common::SerumEntry>::ChartData(const ae::chart::v2::Chart& primary, const ae::chart::v2::Chart& secondary, match_level_t match_level)
...
template <> template <> CommonAntigensSera::Impl::ChartData<common::SerumEntry>::ChartData(const ae::chart::v2::Chart& primary, const ae::chart::v2::Chart& secondary, common::serum_selector_t selector, match_level_t match_level)
    : primary_(primary.number_of_sera()), secondary_(secondary.number_of_sera()),
      primary_base_{primary.number_of_antigens()}, secondary_base_{secondary.number_of_antigens()},
      min_number_{std::min(primary_.size(), secondary_.size())}
{
...
template <> CommonAntigensSera::Impl::ChartData<common::SerumEntry>::ChartData(const ae::chart::v2::Chart& primary)
...
score_t CommonAntigensSera::Impl::ChartData<AgSrEntry>::match(const AgSrEntry& primary, const AgSrEntry& secondary, ae::chart::v2::CommonAntigensSera::match_level_t match_level) const
{
...
ae::chart::v2::CommonAntigensSera::CommonAntigensSera(const Chart& primary, const Chart& secondary, match_level_t match_level)
...
ae::chart::v2::CommonAntigensSera::CommonAntigensSera(const Chart& primary, const Chart& secondary, common::antigen_selector_t antigen_entry_extractor, common::serum_selector_t serum_entry_extractor, match_level_t match_level)
    : impl_(std::make_unique<Impl>(primary, secondary, antigen_entry_extractor, serum_entry_extractor, match_level))
{

} // ae::chart::v2::CommonAntigensSera::CommonAntigensSera

// ----------------------------------------------------------------------

// for procrustes between projections of the same chart
ae::chart::v2::CommonAntigensSera::CommonAntigensSera(const Chart& primary)
...
ae::chart::v2::CommonAntigensSera::CommonAntigensSera(CommonAntigensSera&&) = default;
ae::chart::v2::CommonAntigensSera& ae::chart::v2::CommonAntigensSera::operator=(CommonAntigensSera&&) = default;
...
std::string ae::chart::v2::CommonAntigensSera::report(size_t indent) const
{
    using namespace std::string_view_literals;
...
std::string ae::chart::v2::CommonAntigensSera::report_unique(size_t indent) const
{
    using namespace std::string_view_literals;
...
ae::chart::v2::CommonAntigensSera::operator bool() const
{
...
void ae::chart::v2::CommonAntigensSera::keep_only(const PointIndexList& antigens, const PointIndexList& sera)
{
    if (antigens.empty())
...
} // ae::chart::v2::CommonAntigensSera::keep_only

// ----------------------------------------------------------------------

void ae::chart::v2::CommonAntigensSera::antigens_only()   // remove sera from common lists
{
    impl_->sera_.clear();

} // ae::chart::v2::CommonAntigensSera::antigens_only

// ----------------------------------------------------------------------

void ae::chart::v2::CommonAntigensSera::sera_only()   // remove antigens from common lists
{
    impl_->antigens_.clear();

} // ae::chart::v2::CommonAntigensSera::sera_only

// ----------------------------------------------------------------------

size_t ae::chart::v2::CommonAntigensSera::common_antigens() const
{
    return impl_->antigens_.number_of_common_;

} // ae::chart::v2::CommonAntigensSera::common_antigens

// ----------------------------------------------------------------------

size_t ae::chart::v2::CommonAntigensSera::common_sera() const
{
    return impl_->sera_.number_of_common_;

} // ae::chart::v2::CommonAntigensSera::common_sera

// ----------------------------------------------------------------------

std::vector<ae::chart::v2::CommonAntigensSera::common_t> ae::chart::v2::CommonAntigensSera::antigens() const
{
...
std::vector<ae::chart::v2::CommonAntigensSera::common_t> ae::chart::v2::CommonAntigensSera::sera() const
{
...
ae::chart::v2::Indexes ae::chart::v2::CommonAntigensSera::common_primary_antigens() const
{
...
} // ae::chart::v2::CommonAntigensSera::common_primary_antigens

// ----------------------------------------------------------------------

// returns serum indexes (NOT point indexes)!
ae::chart::v2::Indexes ae::chart::v2::CommonAntigensSera::common_primary_sera() const
{
    const auto srs{sera()};
...
} // ae::chart::v2::CommonAntigensSera::common_primary_sera

// ----------------------------------------------------------------------

std::vector<ae::chart::v2::CommonAntigensSera::common_t> ae::chart::v2::CommonAntigensSera::sera_as_point_indexes() const
{
...
} // ae::chart::v2::CommonAntigensSera::sera_as_point_indexes

// ----------------------------------------------------------------------

std::vector<ae::chart::v2::CommonAntigensSera::common_t> ae::chart::v2::CommonAntigensSera::points(subset a_subset) const
{
    switch (a_subset) {
      case subset::all:
          return points();
...
} // ae::chart::v2::CommonAntigensSera::points

// ----------------------------------------------------------------------

std::vector<ae::chart::v2::CommonAntigensSera::common_t> ae::chart::v2::CommonAntigensSera::points() const
{
...
} // ae::chart::v2::CommonAntigensSera::points_for_primary_sera

// ----------------------------------------------------------------------

std::optional<size_t> ae::chart::v2::CommonAntigensSera::antigen_primary_by_secondary(size_t secondary_no) const
{
    return impl_->antigens_.primary_by_secondary(secondary_no);

} // ae::chart::v2::CommonAntigensSera::antigen_primary_by_secondary

// ----------------------------------------------------------------------

std::optional<size_t> ae::chart::v2::CommonAntigensSera::antigen_secondary_by_primary(size_t primary_no) const
{
    return impl_->antigens_.secondary_by_primary(primary_no);

} // ae::chart::v2::CommonAntigensSera::antigen_secondary_by_primary

// ----------------------------------------------------------------------

std::optional<size_t> ae::chart::v2::CommonAntigensSera::serum_primary_by_secondary(size_t secondary_no) const
{
    return impl_->sera_.primary_by_secondary(secondary_no);

} // ae::chart::v2::CommonAntigensSera::serum_primary_by_secondary

// ----------------------------------------------------------------------

std::optional<size_t> ae::chart::v2::CommonAntigensSera::serum_secondary_by_primary(size_t primary_no) const
{
    return impl_->sera_.secondary_by_primary(primary_no);

} // ae::chart::v2::CommonAntigensSera::serum_secondary_by_primary

// ----------------------------------------------------------------------

ae::chart::v2::CommonAntigensSera::match_level_t ae::chart::v2::CommonAntigensSera::match_level(std::string_view source)
{
...
} // ae::chart::v2::CommonAntigensSera::match_level
