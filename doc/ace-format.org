# Time-stamp: <2022-05-24 09:24:11 eu>
...
|     |      | "T" |     | object             |               | :text:         | style of text                                                                                                                                                  |
|     |      |     | "t" | str                |               |                | multi-line text, lines are separated by \n                                                                                                                     |
|     |      |     | "f" | str                | "helvetica"   | :font-face:    | font face                                                                                                                                                      |
|     |      |     | "S" | str                | "normal"      |                | font slant: "normal" (default), "italic"                                                                                                                       |
|     |      |     | "W" | str                | "bold"        |                | font weight: "normal" (default), "bold"                                                                                                                        |
...
|     |      |     | "f" | str                | "helvetica"   | :font-face:    | font face                                                                                                                                                      |
|     |      |     | "S" | str                | "normal"      |                | font slant: "normal" (default), "italic"                                                                                                                       |
|     |      |     | "W" | str                | "normal"      |                | font weight: "normal" (default), "bold"                                                                                                                        |
|     |      |     | "s" | float              |               |                | label size, default 1.0                                                                                                                                        |
|     |      |     | "c" | color              |               |                | label color, default: "black"                                                                                                                                  |
|     |      |     | "i" | float              | 0.2           |                | addtional interval between lines as a fraction of line height                                                                                                  |
|     |      | "T" |     | object             |               | :text:         | title and its style                                                                                                                                            |
|     |      |     | "t" | str                |               |                | title text, title is not shown if text is empty, text may include newlines                                                                                     |
|     |      |     | "f" | str                | "helvetica"   | :font-face:    | font face                                                                                                                                                      |
|     |      |     | "S" | str                | "normal"      |                | font slant: "normal" (default), "italic"                                                                                                                       |
|     |      |     | "W" | str                | "bold"        |                | font weight: "normal" (default), "bold"                                                                                                                        |
|     |      |     | "s" | float              |               |                | label size, default 1.0                                                                                                                                        |
